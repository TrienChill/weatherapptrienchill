...
class WeatherDataAdapter (
    ...
    private companion object{
        private const val INDEX_CURRENT_LOCATION = 0
        private const val INDEX_CURRENT_WEATHER = 1
        private const val INDEX_FORECAST = 2
    }
    ...
    fun setForecastData(forecast: List<Forecast>) {
        ...
        notifyItemRangeChanged(INDEX_CURRENT_WEATHER, weatherData.size)
    }
    ...
    // Thêm phương thức getItemCount() để trả về số lượng phần tử
    ...
    inner class CurrentLocationViewHolder(
        ...
        fun bind(currentLocation: CurrentLocation) {
            with(binding) {
                ...
                // Thêm sự kiện onClickListener cho textCurrentLocation
